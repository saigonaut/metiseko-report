(function() {
    ...
    function() {
        ...
        angular.module("app.tables", []).controller("tableCtrl", ["$scope", "$filter", function($scope, $filter) {
        ...
        }]).controller("storeReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.stores = [{
                name: "Nijiya Market",
                price: "$$",
        ...
        }]).controller("sellerReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.sellers = [{
                store_name: "Tea Era",
                name: "Yusa",
                revenue: 292
            }, {
                store_name: "Eat On Monday Truck",
                name: "Dau",
                revenue: 119
            }, {
                store_name: "Tea Era",
                ...
                store_name: "The Milk Pail Market",
                name: "Hidehisa",
                revenue: 543,
                rating: 4.5
            }, {
                store_name: "Nob Hill Foods",
                name: "Akita",
                revenue: 874,
                rating: 4
            }, {
                ...
                store_name: "Gochi Japanese Fusion Tapas",
                name: "Phal",
                revenue: 56
            }, {
                store_name: "Cost Plus World Market",
                name: "Rin",
                revenue: 79
            }, {
                store_name: "Bumble Bee Health Foods",
                name: "Maiko",
                revenue: 43
            }, {
                store_name: "Costco",
                ...
                store_name: "Red Rock Coffee Co",
                name: "Jin",
                revenue: 765
            }, {
                store_name: "99 Ranch Market",
                name: "Py",
                revenue: 181
            }, {
                store_name: "Mi Pueblo Food Center",
                name: "Aka",
                revenue: 78
            }, {
                store_name: "Cucina Venti",
                name: "Chairo",
                revenue: 163
            }, {
                store_name: "Sufi Coffee Shop",
                name: "Kin",
                revenue: 113
            }, {
                store_name: "Dana Street Roasting",
                name: "Gin",
                revenue: 316
            }, {
                store_name: "Pearl Cafe",
                name: "Aoi",
                revenue: 173
            }, {
                store_name: "Posh Bagel",
                name: "Kiiroi",
                revenue: 140
            }, {
                store_name: "Artisan Wine Depot",
                name: "Midori",
                revenue: 26
            }, {
                store_name: "Hong Kong Chinese Bakery",
                name: "Kaban",
                revenue: 182
            }, {
                ...
                store_name: "Tapioca Express",
                name: "Ren",
                revenue: 301
            }, {
                store_name: "House of Bagels",
                name: "Kanashi",
                revenue: 82
            }], $scope.searchKeywords = "", $scope.filteredSellers = [], $scope.row = "", $scope.select = function(page) {
                var end, start;
                return start = (page - 1) * $scope.numPerPage, end = start + $scope.numPerPage, $scope.currentPageSellers = $scope.filteredSellers.slice(start, end)
            }, $scope.onFilterChange = function() {
                return $scope.select(1), $scope.currentPage = 1, $scope.row = ""
            }, $scope.onNumPerPageChange = function() {
                return $scope.select(1), $scope.currentPage = 1
                ...
                return $scope.filteredSellers = $filter("filter")($scope.sellers, $scope.searchKeywords), $scope.onFilterChange()
            }, $scope.order = function(rowName) {
                return $scope.row !== rowName ? ($scope.row = rowName, $scope.filteredSellers = $filter("orderBy")($scope.sellers, rowName), $scope.onOrderChange()) : void 0
            }, $scope.numPerPageOpt = [3, 5, 10, 20], $scope.numPerPage = $scope.numPerPageOpt[2], $scope.currentPage = 1, $scope.currentPageSellers = [], (init = function() {
                return $scope.search(), $scope.select($scope.currentPage)
            })()
        }]).controller("productReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.products = [{
                product_name: "Tea Era",
                collection:"METIS",
                pattern: "Graphic rice",
                revenue: 292
            }, {
                product_name: "Eat On Monday Truck",
                collection:"METIS",
                pattern: "Into the wild",
                revenue: 119
            }, {
                product_name: "Tea Era",
                collection:"METIS",
                ...
                product_name: "The Milk Pail Market",
                collection:"METIS",
                pattern: "Into the wild",
                revenue: 543,
                rating: 4.5
            }, {
                product_name: "Nob Hill Foods",
                collection:"METIS",
                pattern: "Graphic rice",
                revenue: 874,
                rating: 4
                ...
                product_name: "Gochi Japanese Fusion Tapas",
                collection:"METIS",
                pattern: "Tapioca",
                revenue: 56
            }, {
                product_name: "Cost Plus World Market",
                collection:"METIS",
                pattern: "Tapioca",
                revenue: 79
            }, {
                product_name: "Bumble Bee Health Foods",
                collection:"METIS",
                pattern: "Tapioca",
                revenue: 43
            }, {
                ...
                product_name: "Red Rock Coffee Co",
                collection:"METIS",
                pattern: "Tapioca",
                revenue: 765
            }, {
                product_name: "99 Ranch Market",
                collection:"METIS",
                pattern: "Travellers palm",
                revenue: 181
            }, {
                product_name: "Mi Pueblo Food Center",
                collection:"METIS",
                pattern: "Travellers palm",
                revenue: 78
            }, {
                product_name: "Cucina Venti",
                collection:"METIS",
                pattern: "Travellers palm",
                revenue: 163
            }, {
                product_name: "Sufi Coffee Shop",
                collection:"METIS",
                pattern: "Travellers palm",
                revenue: 113
            }, {
                product_name: "Dana Street Roasting",
                collection:"METIS",
                pattern: "Travellers palm",
                revenue: 316
            }, {
                product_name: "Pearl Cafe",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 173
            }, {
                product_name: "Posh Bagel",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 140
            }, {
                product_name: "Artisan Wine Depot",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 26
            }, {
                product_name: "Hong Kong Chinese Bakery",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 182
            }, {
                ...
                product_name: "Tapioca Express",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 301
            }, {
                product_name: "House of Bagels",
                collection:"METIS",
                pattern: "Blue bird in summer",
                revenue: 82
            }], $scope.searchKeywords = "", $scope.filteredProducts = [], $scope.row = "", $scope.select = function(page) {
                var end, start;
        ...
        }]).controller("invoiceReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.invoices = [{
                shop: "140-142 Tran Phu",
                seller:"Akita",
                customer: "Kazushi",
                revenue: 292,
                item:[
                {
                    quantity:1,
                    name:"ZEPHIR - LIGHT FOREST"
                }, {
                    quantity:1,
                    name:"ZEPHIR - ON MY WAY"
                }, {
                    quantity:1,
                    name:"ZEPHIR - SUMMER WINGS"
                }],
                date:"11/28/2016 02:47:42 PM"
            }, {
                shop: "Sai Gon",
                seller:"Yusa",
                customer: "Hidehisa",
                ...
                date:"11/28/2016 02:47:42 PM"
            }], $scope.searchKeywords = "", $scope.filteredInvoices = [], $scope.row = "", $scope.select = function(page) {
                var end, start;
            ...
            }, $scope.numPerPageOpt = [3, 5, 10, 20], $scope.numPerPage = $scope.numPerPageOpt[2], $scope.currentPage = 1, $scope.currentPageInvoices = [], (init = function() {
                return $scope.search(), $scope.select($scope.currentPage)
            })()
        }]).controller("supplyModelReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.supply = [{
                model: "HANI",
                pattern:"Hats poetry",
                ...
                return $scope.filteredSupply = $filter("filter")($scope.supply, $scope.searchKeywords), $scope.onFilterChange()
            }, $scope.order = function(rowName) {
                return $scope.row !== rowName ? ($scope.row = rowName, $scope.filteredSupply = $filter("orderBy")($scope.supply, rowName), $scope.onOrderChange()) : void 0
            }, $scope.numPerPageOpt = [3, 5, 10, 20], $scope.numPerPage = $scope.numPerPageOpt[2], $scope.currentPage = 1, $scope.currentPageSupply = [], (init = function() {
                return $scope.search(), $scope.select($scope.currentPage)
            })()
        }]).controller("supplyPatternReportCtrl", ["$scope", "$filter", function($scope, $filter) {
            var init;
            return $scope.supply = [{
                pattern: "HATS POETRY",
                timesquare:25,
                ...
                cao:5,
                loi:10
            }], $scope.searchKeywords = "", $scope.filteredISupply = [], $scope.row = "", $scope.select = function(page) {
                var end, start;
                return start = (page - 1) * $scope.numPerPage, end = start + $scope.numPerPage, $scope.currentPageSupply = $scope.filteredISupply.slice(start, end)
            }, $scope.onFilterChange = function() {
                return $scope.select(1), $scope.currentPage = 1, $scope.row = ""
            }, $scope.onNumPerPageChange = function() {
                return $scope.select(1), $scope.currentPage = 1
                ...
                return $scope.filteredISupply = $filter("filter")($scope.supply, $scope.searchKeywords), $scope.onFilterChange()
            }, $scope.order = function(rowName) {
                return $scope.row !== rowName ? ($scope.row = rowName, $scope.filteredISupply = $filter("orderBy")($scope.supply, rowName), $scope.onOrderChange()) : void 0
            }, $scope.numPerPageOpt = [3, 5, 10, 20], $scope.numPerPage = $scope.numPerPageOpt[2], $scope.currentPage = 1, $scope.currentPageSupply = [], (init = function() {
                return $scope.search(), $scope.select($scope.currentPage)
            })()
        }])
    ...
    function() {
        "use strict";
        angular.module("app", ["ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart", "mgo-angular-wizard", "textAngular", "angular-loading-bar", "duScroll", "app.ui.ctrls", "app.ui.directives", "app.ui.services", "app.controllers", "app.directives", "app.form.validation", "app.ui.form.ctrls", "app.ui.form.directives", "app.tables", "app.task", "app.localization", "app.chart.ctrls", "app.chart.directives"]).config(["$routeProvider", function($routeProvider) {
            return $routeProvider.when("/", {
                redirectTo: "/dashboard"
            }).when("/dashboard", {
                templateUrl: "views/dashboard.html"
            }).when("/report/sale/store", {
                templateUrl: "views/report/store.html"
            }).when("/report/sale/seller", {
                templateUrl: "views/report/seller.html"
            }).when("/report/sale/product", {
                templateUrl: "views/report/product.html"
            }).when("/report/supplier/model", {
                templateUrl: "views/report/model.html"
            }).when("/report/supplier/pattern", {
                templateUrl: "views/report/pattern.html"
            }).when("/report/supplier/abc", {
                templateUrl: "views/report/abc.html"
            }).when("/report/invoice", {
                templateUrl: "views/report/invoice.html"
            }).when("/report/inventory", {
                templateUrl: "views/report/inventory.html"
            }).when("/ui/typography", {
    ...
    function() {
        "use strict";
        angular.module("app.controllers", []).controller("AppCtrl", ["$scope", "$location", "$rootScope", "$route", "$document", function($scope, $location, $rootScope, $route, $document) {
